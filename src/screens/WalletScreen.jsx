    ...
    <div className="min-h-screen">
      ...
      <div className="px-10 pb-12 grid grid-cols-[1.1fr_1fr] gap-6">
        ...
        <div className="space-y-6">
          <Card className="p-6">
            <div className="flex items-center justify-between mb-5">
              <SectionHeader eyebrow="Seus cartões" title="3 cartões · 1 ativo na viagem"/>
            ...
            <div className="relative h-[280px] flex items-end justify-center mb-2">
              {mockData.cards.map((c, i) => {
                const active = c.id === activeCard;
                const offset = (i - mockData.cards.findIndex(x => x.id === activeCard)) * 36;
                const isLast = i === mockData.cards.length - 1;
                return (
          ...
          <Card className="p-6">
            <div className="flex items-start justify-between mb-5">
              <div>
                ...
                <div className="text-[12.5px] text-ink-500 mt-1">A Voya escolhe o cartão ideal para cada gasto da sua viagem.</div>
              </div>
            ...
            <div className="space-y-2">
              ...
              <BestRow icon={Icon.Bed}      label="Hotéis Voya Collection"    card="Voya Signature"             perk="5× pts · upgrade automático"/>
              <BestRow icon={Icon.Utensils} label="Restaurantes premium"      card="Voya Signature"             perk="5× pts · concierge reservas"/>
        ...
        <div className="space-y-6">
          ...
          {/* Benefits grid */}
          <Card className="p-6">
            <SectionHeader eyebrow="Voya · Benefícios" title="O que está ativo agora"/>
          ...
          <Card className="p-6 bg-gradient-to-br from-ink-900 to-ink-800 text-paper border-ink-900">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="text-[16px] font-medium mt-1">Transferir 20.000 pts Voya → TudoAzul agora</div>
        ...
        {openBenefit && (
          <div className="space-y-4">
            ...
            <div className="bg-ink-50 rounded-xl p-3 text-[12.5px] text-ink-600">
              Voya cuida de tudo automaticamente. Você não precisa enviar nenhum comprovante — se acontecer algo, a Voya já está dentro.
            </div>
          </div>
        )}
      </Modal>
  ...
  return (
    <div className={`w-[380px] h-[230px] rounded-2xl ${tones} p-6 flex flex-col shadow-pop relative overflow-hidden
      ...
      <div className="flex items-start justify-between relative">
        <div>
          <div className="text-[10px] tracking-[0.2em] uppercase opacity-70">Voya</div>
